...
class TextAnalyzer:
    ...
    def __init__(self, filepath):
        ...
        lines (list)"""
        self.main_path = "/Users/abhayshakhapur/Documents/umsi206/proj1-win21-abhayshakhapur/"
        self.filepath = filepath
        f = open(self.main_path+self.filepath, 'r')
        self.lines = f.readlines()
        f.close()
        f1 = open(self.main_path+"stopwords.txt", "r")
        self.stop_word_list = [line.rstrip() for line in f1]
        f1.close()
    ...
    def words(self):
        ...
        for aline in self.lines:
            ...
            for word in words:
                word = word.lower()
                edited = "".join(x for x in word if x not in punct_list)
                no_punct.append(edited)
        return no_punct
    ...
    def word_count(self):
        ...
        #file_words is a list of words in the text
        file_words = self.remove_stopwords(self.words())
    ...
    def frequencies(self):
        ...
        for word in file_words:
            if word not in frequency:
                frequency[word]=file_words.count(word)
        return frequency
    ...
    def frequency_of(self, word):
        ...
        if word in frequency_dict.keys():
            return frequency_dict.get(word)
        else:
            return 0
    ...
    def percent_frequencies(self):
        ...
        for word in frequency_dict:
            percent_frequencies[word]=frequency_dict.get(word)/word_count
    ...
    def most_common(self):
        ...
        return list(sorted_frequency[0])
    ...
    def five_least_common(self):
        ...
        five_least_common = []
        for x in range(5):
            five_least_common.append(sorted_frequency[x])
        return five_least_common
    ...
    def read_sample_csv(self):
        ...
        with open(self.main_path+'sample.csv', 'r') as f:
            reader = csv.reader(f)
            for row in reader:
                fieldnames = row
                break
        ...
        for word in fieldnames:
            fieldnames_edited.append(word.strip())
        #print(fieldnames_edited)
        return fieldnames_edited
    ...
    def write_analysis_details(self, csvfile):
        ...
        # Output Format: filepath, total words, word count removing stopwords, line count, most common word
        details = [self.filepath, len(self.words()), self.word_count(), self.line_count(), list(self.most_common())[2]]
        with open(self.main_path+csvfile, 'w') as File:
            writer = csv.writer(File)
            writer.writerow(self.read_sample_csv())
